...
public class he implements jx {

   public hh[] a = new hh[37];
   public hh[] b = new hh[4];
   public hh[] c = new hh[4];
   public int d = 0;
   private ft f;
   ...
   public boolean b(fw var1) {
      if(var1.bt != jr.d && var1.bt != jr.e && var1.bt != jr.t && var1.bt != jr.s) {
         return true;
      } else {
         hh var2 = this.a(this.d);
   ...
   public int e() {
      ...
      for(int var4 = 0; var4 < this.b.length; ++var4) {
         if(this.b[var4] != null && this.b[var4].a() instanceof hf) {
            int var5 = this.b[var4].c();
            int var6 = this.b[var4].d;
            int var7 = var5 - var6;
            var2 += var7;
            var3 += var5;
            int var8 = ((hf)this.b[var4].a()).bc;
            var1 += var8;
         }
      }
   ...
   public void b(int var1) {
      for(int var2 = 0; var2 < this.b.length; ++var2) {
         if(this.b[var2] != null && this.b[var2].a() instanceof hf) {
            this.b[var2].a(var1);
            if(this.b[var2].a == 0) {

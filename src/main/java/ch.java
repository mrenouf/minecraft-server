...
public class ch extends dv {
   ...
   public ch(el var1, float var2, float var3, float var4) {
      this(var1);
      this.a((double)var2, (double)var3, (double)var4);
      float var5 = (float)(Math.random() * 3.1415927410125732D * 2.0D);
      this.s = (double)(-hb.a(var5 * 3.1415927F / 180.0F) * 0.02F);
      this.t = 0.20000000298023224D;
      this.u = (double)(-hb.b(var5 * 3.1415927F / 180.0F) * 0.02F);
      this.L = false;
      this.a = 80;
      this.m = (double)var2;
      this.n = (double)var3;
   ...
   private void c() {
      float var1 = 4.0F;
      this.l.a((dv)null, this.p, this.q, this.r, var1);
   }

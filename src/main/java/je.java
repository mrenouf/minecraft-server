...
public class je extends ey implements eu {
   ...
   public je(MinecraftServer var1, bh var2, ep var3) {
      this.d = var1;
      this.b = var2;
      var2.a(this);
      this.e = var3;
   ...
   public void a(gz var1) {
      ...
      if(this.j) {
         ...
         double var12;
         if(this.e.k != null) {
            float var22 = this.e.v;
            float var3 = this.e.w;
            this.e.k.z();
            var4 = this.e.p;
            var6 = this.e.q;
            double var23 = this.e.r;
            var10 = 0.0D;
            var12 = 0.0D;
            if(var1.i) {
               var22 = var1.e;
            ...
            this.e.k();
            this.e.b(var4, var6, var23, var22, var3);
            this.e.s = var10;
            this.e.u = var12;
            this.e.k.b_();
            return;
   ...
   public void a(double var1, double var3, double var5, float var7, float var8) {
      ...
      this.e.a.b(new ed(var1, var3 + 1.6200000047683716D, var3, var5, var7, var8, false));
   }
   ...
   public void a(hz var1) {
      ...
      int var19 = var1.c;
      int var7 = var1.d;
      int var8 = (int)hd.e((float)(var18 - this.d.e.m));
      int var9 = (int)hd.e((float)(var19 - this.d.e.o));
      if(var8 > var9) {
         var9 = var8;
      }
      ...
      if(var1.e == 0) {
         ...
         if(var16 < 256.0D) {
            this.e.a.b(new fj(var18, var5, var19, this.d.e));
         }
      }
   ...
   public void a(fx var1) {
      boolean var2 = this.d.e.B = this.d.f.g(this.e.ar);
      if(var1.e == 255) {
         hj var3 = var1.a >= 0?new hj(var1.a):null;
         this.e.c.a(this.e, this.d.e, var3);
      } else {
         int var10 = var1.b;
         int var4 = var1.c;
         int var5 = var1.d;
         int var6 = var1.e;
         int var7 = (int)hd.e((float)(var10 - this.d.e.m));
         int var8 = (int)hd.e((float)(var5 - this.d.e.o));
         if(var7 > var8) {
            var8 = var7;
         }

         if(var8 > 16 || var2) {
            hj var9 = var1.a >= 0?new hj(var1.a):null;
            this.e.c.a(this.e, this.d.e, var9, var10, var4, var5, var6);
         }

         this.e.a.b(new fj(var10, var4, var5, this.d.e));
         if(var6 == 0) {
            --var4;
         }
   ...
   public void a(gp var1) {
      ...
      this.e.ak.a[this.e.ak.d] = this.k;
      this.d.k.a(this.e, new gp(this.e.g, var2));
   }
   ...
   public void a(l var1) {
      ...
      gh var8 = new gh(this.d.e, var2, var4, var6, new hj(var1.h, var1.i));
   ...
   private void d(String var1) {
      if(var1.toLowerCase().startsWith("/me ")) {
         ...
         if(var2.length >= 3) {
            ...
            if(!this.d.f.a(var2[1], new bg(var1))) {
               this.b(new bg("\u00a7cThere\'s no player by that name online."));
            }
         }
      ...
      if(var1.e.d("x") == var1.a) {
         if(var1.e.d("y") == var1.b) {
            if(var1.e.d("z") == var1.c) {
               ay var2 = this.d.e.k(var1.a, var1.b, var1.c);
               if(var2 != null) {
                  try {
                     var2.a(var1.e);
   ...
   public void a(a var1) {
      dw var2 = this.d.e.a(var1.b);
      if(var2 != null && this.e.g(var2)) {
         var2.a(this.e);
      }
